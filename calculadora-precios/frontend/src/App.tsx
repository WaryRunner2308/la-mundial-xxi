    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[100] p-4">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-2">¿Cuál es la tasa de cambio de hoy?</p>
          <p className="text-sm text-gray-500 mt-1">(1 USD = X Bs)</p>
        </div>
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-lg text-center"
              autoFocus
              autoComplete="off"
            />
          </div>
          <button
            type="submit"
            className="w-full py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-lg shadow-lg transition"
          >
            Continuar
          </button>
        </form>
    ...
    <BrowserRouter>
      <div className="flex min-h-screen bg-gray-50">
        <aside className="w-64 bg-white border-r shadow-sm flex flex-col h-screen">
          {/* Bloque Superior: Header + Nav */}
          <div className="flex flex-col">
            <div className="flex-shrink-0 flex items-center px-4 py-6 border-b">
              <span className="text-xl font-semibold text-gray-900">La Mundial</span>
            </div>
            <nav className="px-4 py-2 flex-shrink-0">
              <NavLink
                to="/products"
                className={({ isActive }) =>
                  `flex items-center px-3 py-2 rounded-md font-medium transition-colors duration-150 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'
                  }`
                }
              >
                Productos
          ...
          {/* Bloque Central: Personajes centrados */}
          <div className="flex-grow flex items-center justify-center px-4">
            <img src="/logo.png" alt="La Mundial XXI" className="w-full object-contain" />
          </div>

          {/* Bloque Inferior: Espaciador fijo */}
